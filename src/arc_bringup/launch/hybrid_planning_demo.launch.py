...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="arc_robot_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="arc_ur_demo.urdf.xacro",
    ...
    kinematics_yaml = load_yaml("arc_moveit_config", "config/kinematics.yaml")
    robot_description_kinematics = {"robot_description_kinematics": kinematics_yaml}

    # Planning Configuration
    ompl_pipeline = load_yaml("arc_moveit_config", "config/ompl_planning.yaml")
    ...
    joint_limits_yaml = {
        "robot_description_planning": load_yaml(
            "arc_robot_description",
            os.path.join("config", "ur5e", "pilz_joint_limits.yaml"),
        )
    }
    cartesian_limits_yaml = {
        "robot_description_planning": load_yaml(
            "arc_robot_description",
            os.path.join("config", "ur5e", "cartesian_limits.yaml"),
        )
    }
